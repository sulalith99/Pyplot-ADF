...
awk '{print $1","$2}' abs_gauss.data >> $outname_test.csv

rm abs_gauss.data
rm abs_stick.data
rm abstemp.data

echo "Excitation energy (eV),Oscillator Strength" >> abs_gauss.csv
sort -t, -r -gk2 $outname_test.csv >> abs_gauss.csv
rm $outname_test.csv
...
sort -t, -r -gk4 absdata.csv >> abs.csv
